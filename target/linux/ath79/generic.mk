...
define Device/linkap_xr750-v1
  ...
  IMAGE/factory.bin := append-kernel | pad-to 1728k | append-rootfs | pad-rootfs | pad-to $$(IMAGE_SIZE) | check-size
  IMAGE/sysupgrade.bin := append-kernel | pad-to 1728k | append-rootfs | pad-rootfs | \
        append-metadata | check-size
